...
high_volubility_samples.to_csv('high.csv', index = False)
...
random_sampler.segments[['recording_filename', 'segment_onset', 'segment_offset']].to_csv('random.csv', index = False)